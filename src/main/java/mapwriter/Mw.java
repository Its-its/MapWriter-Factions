...
public class Mw {
	...
	public void reloadMapTexture() {
		...
		UndergroundTexture newTexture = new UndergroundTexture(this,
				this.textureSize, Config.linearTextureScaling);
	...
	public void load() {
		...
		this.mapTexture = new MapTexture(this.textureSize,
				Config.linearTextureScaling);
		this.undergroundMapTexture = new UndergroundTexture(this,
				this.textureSize, Config.linearTextureScaling);
	...
	public void onPlayerDeath(EntityPlayerMP player) {
		if (this.ready && (Config.maxDeathMarkers > 0)) {
			...
			this.markerManager.addMarker(Utils.getCurrentDateString(),
					...
					this.playerZInt, this.playerDimension, 0xffff0000);
