...
public class SurfacePixels {
	...
	public void updateChunk(MwChunk chunk) {
		...
		// TODO: refactor so that blockColours can be accessed more directly
		
		// use ceiling algorithm for nether
		ChunkRender.renderSurface(this.region.regionManager.blockColours, chunk, pixels, offset, Region.SIZE, (chunk.dimension == -1));
