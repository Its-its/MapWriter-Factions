...
public class OverlaySlime implements IMwDataProvider {
	...
	public class ChunkOverlay implements IMwChunkOverlay {
		...
		@Override public int getColor() { return 0x5000ff00; }
		...
		@Override public int getBorderColor() { return 0xff000000; }

		@Override public boolean customBorder() { return false; }

		@Override public void drawCustom(Double topCorner, Double botCorner) {}

		@Override public void drawCustomBorder(Double topCorner, Double botCorner) {}
	...
	@Override public String getStatusString(int dim, int bX, int bY, int bZ) { return ""; }
	@Override public void onMiddleClick(int dim, int bX, int bZ, MapView mapview, MwGui gui) {}
